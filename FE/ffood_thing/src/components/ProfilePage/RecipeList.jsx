...
const RecipeList = () => {
  ...
  const recipes = [
    { id: 1, title: "울리는 맛있는 라멘 🍜", image: `${import.meta.env.BASE_URL}images/recipe1.jpg` },
    { id: 2, title: "김치찌개가 힘들게 가르쳐준...", image: `${import.meta.env.BASE_URL}images/recipe2.jpg` },
    { id: 3, title: "비건짜장면 좋아보이네요...", image: `${import.meta.env.BASE_URL}images/recipe3.jpg` },
    { id: 4, title: "고기없는 떡볶이 🍢", image: `${import.meta.env.BASE_URL}images/recipe4.jpg` },
    { id: 5, title: "해장용 순두부찌개 🍲", image: `${import.meta.env.BASE_URL}images/recipe5.jpg` },
    { id: 6, title: "스테이크 샐러드 🥗", image: `${import.meta.env.BASE_URL}images/recipe6.jpg` },
  ];
