  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/login" element={<PageSlide><LoginPage /></PageSlide>} />

        <Route path="/sns" element={<PageSlide><SnsMain /></PageSlide>} />
        ...
        <Route path="/recipes/write" element={<PageSlide><RecipeWritePage /></PageSlide>} />
        <Route path="/recipes/:id/update" element={<PageSlide><RecipeUpdatePage /></PageSlide>} />

        <Route path="/profile/:id" element={<PageSlide><ProfilePage /></PageSlide>} />

        <Route path="/ai-recommend" element={<PageSlide><AiRecommendPage /></PageSlide>} />
