...
- 참조한 레시피가 있는 경우 해당 레시피로 바로 이동하여 레시피를 확인가능합니다.
  ![alt text](SNS_예시_엘라스틱_서치_포함_.gif)
