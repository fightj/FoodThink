...
- 레시피 메인
  ...
  - 테블릿 기반 웹앱인 만큼 무한 스크롤 페이지네이션을 통해 무리한 데이터 요청을 하지 않습니다.
  - 로그인 사용자에 한하여 레시피 작성을 할 수 있습니다.

- 레시피 디테일

  - 레시피의 기본 정보들을 볼 수 있는 페이지입니다. 재료와 조리 순서, 관련된 피드를 확인할 수 있습니다.
  - 레시피 북마크 기능을 사용하여 마이 페이지에서 쉽게 접근할 수 있습니다.
